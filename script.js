...
const bandeira = document.querySelector('.bandeira'); // A div que deve ser observada
...
function checkVisibility() {
  const rect = bandeira.getBoundingClientRect();
  ...
  if (rect.bottom <= 0 || rect.top >= window.innerHeight) {
    ...
    logoImg.src = "imagens/logo-branca.png"; // Logo original (clara)
    btnWhats.style.color = "yellow"
